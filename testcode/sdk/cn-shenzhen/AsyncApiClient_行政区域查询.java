...
@ThreadSafe
public final class AsyncApiClient_行政区域查询 extends BaseApiClient {
    public final static String GROUP_HOST = "district.market.alicloudapi.com";

    private AsyncApiClient_行政区域查询(BuilderParams builderParams) {
        super(builderParams);
    }

    @NotThreadSafe
    public static class Builder extends BaseApiClientBuilder<AsyncApiClient_行政区域查询.Builder, AsyncApiClient_行政区域查询>{

        @Override
        protected AsyncApiClient_行政区域查询 build(BuilderParams params) {
            return new AsyncApiClient_行政区域查询(params);
        }
    }

    public static Builder newBuilder(){
        return new AsyncApiClient_行政区域查询.Builder();
    }

    public static AsyncApiClient_行政区域查询 getInstance(){
        return getApiClassInstance(AsyncApiClient_行政区域查询.class);
    }

    public void 行政区域查询(String keywords, String subdistrict, String showbiz, String page, String offset, String extensions, String filter, String callback, String output, ApiCallBack _callBack) {
