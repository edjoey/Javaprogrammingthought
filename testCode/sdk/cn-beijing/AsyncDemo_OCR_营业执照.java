...
public class AsyncDemo_OCR_营业执照 {

    private AsyncApiClient_OCR_营业执照 asyncClient = null;

    public AsyncDemo_OCR_营业执照() {
        this.asyncClient = AsyncApiClient_OCR_营业执照.newBuilder()
                .appKey("25055943")
    ...
    public void OCR_营业执照识别Demo(byte[] body) {
        asyncClient.OCR_营业执照识别(body, new ApiCallBack() {
            @Override
